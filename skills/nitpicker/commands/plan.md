...
Write the plan to `docs/plans/<YYYY-MM-DD>-<slug>.md` (create `docs/plans/` if absent). This command writes a plan, not findings: it does not touch the findings store or run `findings.py`. Structure:
