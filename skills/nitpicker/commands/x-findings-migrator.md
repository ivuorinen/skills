...
an agent's verification notes, is skipped and named on stderr. That holds
after a finding's closing field (`Fix:`, or `Fixed:`/`Notes:`) too, where it
would otherwise read as more fix. A finding
