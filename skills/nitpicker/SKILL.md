...
reversible through this server. All ten carry `openWorldHint: false`: no tool
reaches past this repo's files. These are hints a client weighs before calling,
not access control; the root confinement below is the actual boundary.
